    ...
    class Links : SimpleMarkdownLineProcessor
    {
        protected override void ProcessLine(MarkdownLine line, MarkdownRenderingSettings settings)
        {
            ...
            while (linkTextStart > -1)
            {
                ...
                // if (linkContent.Contains(".png")) {
                //     // GameObject verticalLayout = GameObject.Find("VerticalLayout");
                //     // verticalLayout.GetComponent<ImageHelper>().DisplayImage(linkContent);
                ...
                //         else
                //         {
                //             imageHelper.DisplayImage(linkContent);
                //         }
                //     }
                //     return;
                // }
